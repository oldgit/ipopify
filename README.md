...
* **PlayFramework** - currently using 2.3.7 with the scala API
...
```
[info] Loading project definition from ../ipopify/project
[info] Set current project to ipopify
[info] Updating ipopify...
...
[info] Done updating.
